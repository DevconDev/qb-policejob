...
I created this fork with the help of Omen#1072 (big shoutout for helping me with all my errors) and Wafflz#6164 (for fixing blips and forking to fix issues with other qb resources) . This fork supports multi-department functions by changing `PlayerJob.name == "police" with PlayerJob.type == "leo"`.
